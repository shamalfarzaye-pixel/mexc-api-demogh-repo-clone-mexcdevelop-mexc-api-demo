 ...
 * - Run from contract root: `node examples/dev/ws-runner.js` or `node .\run-ws.js`
...
const connector = new MexcFutures({ apiKey, apiSecret })
const client = connector.wsStreams

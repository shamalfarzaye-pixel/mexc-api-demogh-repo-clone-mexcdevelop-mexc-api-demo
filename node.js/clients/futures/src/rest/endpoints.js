 ...
 *
 * Grouping: market | account | order | position | plan | stop | track | stp
 * Paths must stay aligned with go/futures/endpoints.go
 *
...
module.exports = {
  market: {
    ...
    CONTRACT_DETAIL_COUNTRY: '/api/v1/contract/detail/country',
  ...
  account: {
    ...
    /** @deprecated use CONTRACT_FEE_RATE */
  ...
  // Shorter alias names (same paths as ORDER.*)
  trade: {

...
> **Protobuf market stream (Node.js):** `WebSocket/ProtobufStream.js` — Go SDK has no protobuf WS helper.

## WebSocket examples

- `WebSocket/ProtobufStream.js` — Public protobuf market stream (public)
- `WebSocket/PrivateUserDataStream.js` — Private user data via listen key (private)

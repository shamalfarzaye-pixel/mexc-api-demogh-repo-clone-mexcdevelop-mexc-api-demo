...
// WsStream is a lightweight WebSocket client for MEXC Futures.
...
// NewWsStream creates a new WebSocket client using the given config.
func NewWsStream(cfg Config) *WsStream {
	return &WsStream{
		cfg: cfg,
		dialer: &websocket.Dialer{
...
func (c *WsStream) Connect(ctx context.Context) error {
	...
	go func() {
		...
		header.Set("User-Agent", "demo-futures")
...
func (c *WsStream) Unsubscribe(method string, param map[string]any) error {
	if param == nil {
		param = map[string]any{}
	}
	return c.Send(map[string]any{"method": method, "param": param})
...
func (c *WsStream) UnsubTicker(params map[string]any) error {
	p := toSymbolParam(params)
...
// @wsChannel sub.deal
func (c *WsStream) SubDeal(params map[string]any) error {
	p := toSymbolParam(params)
...
func (c *WsStream) UnsubDeal(params map[string]any) error {
	p := toSymbolParam(params)
...
// @wsChannel sub.depth
func (c *WsStream) SubDepth(params map[string]any) error {
	p := toSymbolParam(params)
...
func (c *WsStream) UnsubDepth(params map[string]any) error {
	p := toSymbolParam(params)
...
func (c *WsStream) SubDepthFull(params map[string]any) error {
	p := toSymbolParam(params)
...
func (c *WsStream) UnsubDepthFull(params map[string]any) error {
	p := toSymbolParam(params)
...
// @wsChannel sub.kline
func (c *WsStream) SubKline(params map[string]any) error {
	p := toSymbolParam(params)
...
func (c *WsStream) UnsubKline(params map[string]any) error {
	p := toSymbolParam(params)
	if getStringFromAny(p["interval"]) == "" {
...
func (c *WsStream) SubFundingRate(params map[string]any) error {
	p := toSymbolParam(params)
...
func (c *WsStream) UnsubFundingRate(params map[string]any) error {
	p := toSymbolParam(params)
...
func (c *WsStream) SubIndexPrice(params map[string]any) error {
	p := toSymbolParam(params)
...
func (c *WsStream) UnsubIndexPrice(params map[string]any) error {
	p := toSymbolParam(params)
...
func (c *WsStream) SubFairPrice(params map[string]any) error {
	p := toSymbolParam(params)
...
func (c *WsStream) UnsubFairPrice(params map[string]any) error {
	p := toSymbolParam(params)
...
func (c *WsStream) SubEventContract() error {
...
func (c *WsStream) UnsubEventContract() error {
...
// @wsChannel login
func (c *WsStream) Login(subscribe bool) error {
...
func (c *WsStream) FilterAssets() error {
...
// @wsChannel personal.filter
func (c *WsStream) FilterOrders(params map[string]any) error {
...
// @wsChannel personal.filter
func (c *WsStream) FilterOrderDeals(params map[string]any) error {
	rules, err := normalizeSymbolsParam(params)
	if err != nil {
		return err
	}
...
// @wsChannel personal.filter
func (c *WsStream) FilterPositions(params map[string]any) error {
	rules, err := normalizeSymbolsParam(params)
	if err != nil {
		return err
	}
...
// @wsChannel personal.filter
func (c *WsStream) FilterPlanOrders(params map[string]any) error {
	rules, err := normalizeSymbolsParam(params)
	if err != nil {
		return err
	}
...
// @wsChannel personal.filter
func (c *WsStream) FilterStopOrders(params map[string]any) error {
	rules, err := normalizeSymbolsParam(params)
	if err != nil {
		return err
	}
...
// @wsChannel personal.filter
func (c *WsStream) FilterStopPlanOrders(params map[string]any) error {
	rules, err := normalizeSymbolsParam(params)
	if err != nil {
		return err
	}
...
// @wsChannel personal.filter
func (c *WsStream) FilterRiskLimit() error {
	return c.Send(map[string]any{
		"method": "personal.filter",
		"param": map[string]any{
			"filters": []map[string]any{
...
// @wsChannel personal.filter
func (c *WsStream) FilterAdlLevel() error {
	return c.Send(map[string]any{
		"method": "personal.filter",
		"param": map[string]any{
			"filters": []map[string]any{
...
// @wsChannel personal.filter
func (c *WsStream) ResetPersonalFilters() error {
	return c.Send(map[string]any{
		"method": "personal.filter",
...
// @wsChannel personal.filter
func (c *WsStream) FilterCustom(params map[string]any) error {
	return c.Send(map[string]any{
		"method": "personal.filter",
		"param":  params,
	})
...
func (c *WsStream) OnOpen(fn func()) {
	c.mu.Lock()
	defer c.mu.Unlock()
...
func (c *WsStream) OnClose(fn func(code int, text string)) {
	c.mu.Lock()
	defer c.mu.Unlock()
...
func (c *WsStream) OnError(fn func(error)) {
	c.mu.Lock()
	defer c.mu.Unlock()
...
func (c *WsStream) OnMessage(fn func(raw string, msg map[string]any)) {
	c.mu.Lock()
	defer c.mu.Unlock()
...
func (c *WsStream) OnReconnect(fn func()) {
	c.mu.Lock()
	defer c.mu.Unlock()
...
func (c *WsStream) OnPong(fn func(data any)) {
	c.mu.Lock()
	defer c.mu.Unlock()
...
func (c *WsStream) readLoop(conn *websocket.Conn) {
	for {
...
func (c *WsStream) handleReadError(err error) {
	c.mu.Lock()
	defer c.mu.Unlock()
	c.stopPingLocked()
	if c.conn != nil {
...
func (c *WsStream) startPingLocked() {
	c.stopPingLocked()
...
func (c *WsStream) stopPingLocked() {
	if c.pingTicker != nil {
		c.pingTicker.Stop()
		c.pingTicker = nil
	}
...
func (c *WsStream) scheduleReconnectLocked() {
...
func (c *WsStream) emitClose(code int, text string) {
	c.mu.Lock()
...
func (c *WsStream) emitError(err error) {
	c.mu.Lock()
...
func (c *WsStream) emitMessage(raw string, msg map[string]any) {
	c.mu.Lock()
...
func (c *WsStream) emitPong(data any) {
	c.mu.Lock()

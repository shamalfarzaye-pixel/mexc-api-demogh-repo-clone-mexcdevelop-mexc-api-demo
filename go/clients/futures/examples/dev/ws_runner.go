// Program ws-runner verifies MEXC Futures WebSocket behavior.
// Change the target constant, then run: go run ./clients/futures/examples/dev/ws_runner.go
package main
...
func main() {
	...
	ws := futures.NewClient(cfg).WsStream()
...
func runTarget(ctx context.Context, ws *futures.WsStream, cfg futures.Config, action string) error {
